...
public class SecondaryRevolver : MonoBehaviour
{
	...
	{
		gunReady = false;
		base.transform.localPosition = new Vector3(rev.pickUpPos.localPosition.x * -1f, rev.pickUpPos.localPosition.y, rev.pickUpPos.localPosition.z);
		base.transform.localRotation = rev.pickUpPos.localRotation;
		shootCharge = 0f;
		shootReady = false;
	}
